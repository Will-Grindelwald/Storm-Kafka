...
/**
 * demo1 使用的是老的 Scala 客户端 API 这个 demo 使用的是新的 Java 客户端 API(在 org.apache.kafka.clients package), 注意 maven 依赖
 * 是线程安全的
...
public class TestProducer {
	...
	public static final String partitioner = "cn.ac.sict.kafka_producer_demo2.SimplePartitioner";
	public static final String topicStr = "ljc_page_visits_2";
	...
	private void send(String arg) {
		...
		try {
			...
			for (long nEvents = 0; nEvents < events; nEvents++) {
				...
				this.producer.send(new ProducerRecord<String, String>(topicStr, ip, msg));
			}
